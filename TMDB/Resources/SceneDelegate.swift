...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let savedFilmsNavController = UINavigationController()
        savedFilmsNavController.navigationBar.standardAppearance = appearance
        savedFilmsNavController.navigationBar.scrollEdgeAppearance = appearance
        savedFilmsNavController.navigationBar.compactAppearance = appearance
        savedFilmsNavController.navigationBar.tintColor = .label

        let savedFilmsCoordinator = SavedFilmsCoordinator(navigationController: savedFilmsNavController)
